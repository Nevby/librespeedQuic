package com.group3.speedtest.core.serverSelector;

import org.json.JSONException;
import org.json.JSONObject;

public class TestPoint {
    private final String name, server, dlURL, ulURL, pingURL, getIpURL, tp;
    protected float ping=-1;

    public TestPoint(String name, String server, String dlURL, String ulURL, String pingURL, String getIpURL, String tp){
        this.name=name;
        this.server=server;
        this.dlURL=dlURL;
        this.ulURL=ulURL;
