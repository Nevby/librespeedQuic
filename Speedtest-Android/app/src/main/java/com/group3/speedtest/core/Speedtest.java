package com.group3.speedtest.core;
...
public class Speedtest {
    ...
    private TP selectedTransportProtocol;
    ...
    public void setSpeedtestConfig(SpeedtestConfig c){
        synchronized (mutex){
            ...
            config=c.clone();
            config.setParallelConnections(parallelConnections);
    ...
    /* Modified - Parallel Connections selection */
    public void setParallelConnections(int i) {
        config.setParallelConnections(i);
    ...
    /* Modified - TP selection */
    public void setSelectedTP(TP tp) {
        selectedTransportProtocol = tp;
    }

    public TP getSelectedTP() {
    ...
    public ArrayList<String> getOptionsCCA() {
        ArrayList<String> optionsCCA=new ArrayList<>();
        Log.d("CCA", "getOptionsCCA");
    ...
    public void setOptionsCCA(ArrayList<CCA> cca) {
        Log.d("CCA", "setOptionsCCA");
        congestionControlAlgorithms.clear();
    }
    /* Modified - Congestion Control Algorithms selection */
    ...
    private static class ServerListLoader {
        private static String read(String url){
            try{
                ...
                Log.d("ServerListLoader", "******     Load server failed" + url);
                return null;
            }
        }
        ...
        public static TestPoint[] loadServerList(String url){
            try{
                ...
                if(s==null) {
                    Log.d("loadServer", "******     Load server failed" + url);
