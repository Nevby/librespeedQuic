...
import com.group3.speedtest.core.worker.SpeedtestWorkerQuic;

public class SpeedTestQuic {
    ...
    public SpeedTestQuic(final Activity activity){
    ...
    private SpeedtestWorkerQuic stQuic=null;
    public void start(final SpeedtestHandler callback){
        synchronized (mutex) {
            ...
            stQuic = new SpeedtestWorkerQuic(mainActivity, selectedServer, config, telemetryConfig) {
                @Override
