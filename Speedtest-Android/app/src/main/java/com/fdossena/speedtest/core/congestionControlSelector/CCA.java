package com.fdossena.speedtest.core.congestionControlSelector;
...
public class CCA {
    ...
    public CCA(String name, String server, String dlURL, String ulURL, String pingURL, String getIpURL){
        this.name=name;
        this.server=server;
        this.dlURL=dlURL;
        this.ulURL=ulURL;
