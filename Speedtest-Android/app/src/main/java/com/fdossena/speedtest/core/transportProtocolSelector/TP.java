package com.fdossena.speedtest.core.transportProtocolSelector;
...
public class TP {
    ...
    public TP(String name, String server, String dlURL, String ulURL, String pingURL, String getIpURL){
        this.name=name;
        this.server=server;
        this.dlURL=dlURL;
        this.ulURL=ulURL;
